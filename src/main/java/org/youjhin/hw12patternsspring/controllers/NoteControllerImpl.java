package org.youjhin.hw12patternsspring.controllers;
...
import org.youjhin.hw12patternsspring.controllers.interfaces.NoteController;
...
public class NoteControllerImpl implements NoteController {
    ...
    /**
     * Сохраняет новую заметку через Factory
     *
     * @return Перенаправление на страницу со всеми заметками.
     */
    @PostMapping("/saveNote")
    public String saveNote(@RequestParam("description") String description,
                           @RequestParam("urgency") Urgency urgency) {
        noteService.createNote(description,urgency);
